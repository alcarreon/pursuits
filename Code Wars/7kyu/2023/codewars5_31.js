...
// return integer
// examples
// pseudo code given a string replace all non integers with a space and then split the resulting string into an array and reduce the array to get the final answer
