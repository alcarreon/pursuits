...
// examples
// pseudo code create a class named Animal that takes name and type as parameters and has a method toString which uses the name and type of the object in a template literal
