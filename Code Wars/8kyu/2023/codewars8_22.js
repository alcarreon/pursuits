...
// return integer
// example
// pseudo code use map to iterate over each element, at each element use reduce to find the total number of steps walked for each day, finally use reduce on the resulting array and multiply it by 20
...
function stairsIn20(s) {
  return (
    s.map((day) => day.reduce((a, b) => a + b)).reduce((u, y) => u + y) * 20
  );
}
