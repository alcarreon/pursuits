...
// return 1, 0, -1
// examples
// pseudo code check to see if the absolute value of subtracting a from b is less than the margin, otherwise check to see if a is less than b, if it reachs the last condition return 1
